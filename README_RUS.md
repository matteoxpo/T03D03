...
И небольшая подсказка-ограничение: разрешено подключать только заголовочный файл `<stdio.h>`
...
кодом и файлы с данными (при необходимости) в директорию src, ветку develop. ==***
