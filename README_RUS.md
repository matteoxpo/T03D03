...
>**Внимание:** С этого дня ваши решения будут проверяться автотестами!
...
>**Внимание:** В данном и последующих квестах необходимо сторого придерживаться приведенных в таблице с примерами форматов ввода и вывода данных!
