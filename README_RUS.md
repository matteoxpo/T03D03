...
>**Внимание:** С этого дня ваши решения будут проверяться автотестами и на стилевую норму!
...
>**Внимание:** В данном и последующих квестах необходимо сторого придерживаться приведенных в таблице с примерами форматов ввода и вывода данных! Обращайте внимание действительно ли нужен перенос строк при выводе!
